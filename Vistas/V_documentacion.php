...
<body>
    ...
    <div class="container doc">
        ...
        if ($doc == 'administracion') {
            echo '<br><a href="../doc/Manual.docx" download="Manual.docx">Manual de acogida</a><br><br>
                  <a href="../doc/Procedimientos.docx" download="Procedimientos.docx">Procedimientos</a><br><br>
                  <a href="../doc/Clientes.docx" download="Clientes.docx">Procedimientos con clientes</a>';
        }

        if ($doc == 'demandas') {
            echo '<br><a href="../doc/Manual.docx" download="Manual.docx">Manual de acogida</a><br><br>
                  <a href="../doc/Procedimientos.docx" download="Procedimientos.docx">Procedimientos</a>';
        }
        ...
        if ($doc == 'notificaciones') {
            echo '<br><a href="../doc/Juzgados.docx" download="Juzgados.docx">Listado de juzgados</a><br><br>
                  <a href="../doc/Manual.docx" download="Manual.docx">Manual de acogida</a><br><br> 
                  <a href="../doc/Procedimientos.docx" download="Procedimientos.docx">Procedimientos</a>';
        }
