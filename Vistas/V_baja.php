        ...
        <div class="container">
            <div>
                ...
                <form>
                    ...
                    <input type="radio" id="eliminar" name="eliminar" checked/><span> Eliminar cuenta</span><br>
                    <input type="radio" id="redirigir" name="redirigir" onclick="redireccion()"/> Redirigir cuenta<br>
                    <input type="radio" id="porPTid" name="alias" onclick="alias()"/> Crear alias<br>
                </form>
            </div>
        </div>
